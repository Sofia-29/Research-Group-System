...
namespace IntegrationTests.Infrastructure.Authentication
{
    public class AuthenticationFactory<TStartup>
        : WebApplicationFactory<TStartup> where TStartup : class
    {
        ...
        public static void SeedForAuthenticationTests(IServiceProvider serviceProvider)
        {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var logger = scopedServices.GetRequiredService<ILogger<AuthenticationFactory<TStartup>>>();
                    ...
                    try
                    {
                        ...
                        SeedForAuthenticationTests(scopedServices);
                    }
                    catch (Exception ex)
                    {
